...
class User():
    ...
    def is_valid_password(self, pwd):
        ...
        - Compare `__password` with the MD5 hash of `pwd`
        """
        if pwd is None or not isinstance(pwd, str):
            return False
...
if __name__ == '__main__':
    ...
    if user_1.is_valid_password("Fakepwd"):
        print("is_valid_password should return False if the password is incorrect")
    ...
    if user_2.is_valid_password("No pwd"):
        print("is_valid_password should return False if no password has been set")
